...
func ParseBasicHeader(clientInfo *ClientInfo) {
	var err error
...
func ParseMessageHeader(clientInfo *ClientInfo) {
	var err error
	...
	case 0:
		...
		clientInfo.MessageStreamID = av.Trans4Byte2UINT32(clientInfo.Buff[7:11])
...
func ParseExtendedTimeStamp(clientInfo *ClientInfo) {
	clientInfo.Buff, _ = clientInfo.rw.ReadNByte(4, clientInfo.Buff)
